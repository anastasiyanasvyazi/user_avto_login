describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.wait(4000);
         cy.get('.card_number').type('4303911599022955');                     // вводим номер карты
         cy.get('.card_csv').type('504');                             // вводим CVV карты
         cy.get('.card_date').type('0733');                           // вводим срок действия карты
         cy.get('.card_name').type('Eleanor Vosper');                         // вводим имя владельца действия карты
         cy.get('.style_1_base_button_payment_body > .style_1_base_button_payment').click();     // нажимаем кнопку Оплатить
         cy.get('.threeds_number').type('6056');                            // вводим код подтверждения СМС
         cy.get('.style_1_base_button_payment_body > .style_1_base_button_payment').click();   // нажимаем кнопку Оплатить
